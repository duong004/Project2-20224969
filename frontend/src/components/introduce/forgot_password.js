    ...
    <div className="forgot-login">
      <div className="forgot-login-modal">
        <div className="forgot-login-header">
          <div>
            <h1 style={{ fontSize: "30px", lineHeight: "1.7", fontWeight: "bold" }}>
              Reset Password
            </h1>
            <h2 style={{ marginTop: "10px" }}>
              Điền Email của bạn chúng tôi sẽ gửi mail với mã xác nhận,
              mã xác nhận chỉ có hiệu lực trong 2 phút
            </h2>
          </div>
          <span
        ...
        <form className="forgot-login-form" onSubmit={submit_log}>
          <div className="forgot-form-group">
            <input
              ...
              required
            />
            <button id="login-btn" type="submit">Xác nhận</button>
            {a && (
